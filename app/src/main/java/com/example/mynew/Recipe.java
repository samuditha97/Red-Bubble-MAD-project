    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Recipe.this,RecipeShow.class));
            }
        });
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(Recipe.this,"Data Updated!!",Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(Recipe.this,"Error: "+task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Recipe.this,e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveToFireStore(String id, String title, String desc){
        if(!title.isEmpty() && !desc.isEmpty()){
            ...
            db.collection("Documents").document(id).set(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(Recipe.this,"Recipe Saved!!",Toast.LENGTH_SHORT).show();
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Recipe.this,"Failed!!",Toast.LENGTH_SHORT).show();
                }
            });
